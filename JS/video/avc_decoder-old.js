 ...
 */
importScripts("../lib/h264/baseline/avc.js");
importScripts("../lib/h264/baseline/avc-codec-min.js");
importScripts("../lib/h264/baseline/util.js");
importScripts("../lib/h264/baseline/global-5.js");
var AvcDecoder = (function () {
    ...
    AvcDecoder.prototype._decode = function (data) {
        if(this.avc)
            this.avc.decode(data);
    };
    AvcDecoder.prototype._onPictureDecoded=function(buffer, width, height) {
